...
type
  ...
  protected
    ...
    {$IFDEF TntUnicode}
    procedure GetStrings(aStrings: TTntStrings);
    {$ELSE}
...
procedure TRMPageHeaderFooter.GetStrings(aStrings: TTntStrings);
{$ELSE}
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          t.spLeft := 0;
          t.spWidth := liPage.PrinterInfo.PageWidth - PageLayout.LeftMargin - PageLayout.RightMargin;
...
begin
  ...
  try
    PageWidth := liPage.PrinterInfo.PageWidth - PageLayout.LeftMargin - PageLayout.RightMargin;
    PageHeight := liPage.PrinterInfo.PageHeight - PageLayout.TopMargin - PageLayout.BottomMargin;
    _GetFormRect;
