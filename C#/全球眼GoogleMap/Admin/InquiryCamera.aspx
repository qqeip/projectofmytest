<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InquiryCamera.aspx.cs" Inherits="Admin_InquiryCamera" %>
    ...
    <form id="form1" runat="server">
        <div class="console_tab_head">
            <h4 class="console_head_off">
                <a href="InquiryDvs.aspx">查询编码器</a></h4>
        ...
        <div class="console_content">
            ...
            <table id="adv" class="con_new_table displayNone" style="width: 1050px">
                <tr>
                    <td class="con_new_table_obj">
                        摄像头编码
                    </td>
                    <td colspan="3">
                        <asp:TextBox ID="txtCameraNo" runat="server" CssClass="con_middle"></asp:TextBox>
                    </td>
                    <td class="con_new_table_obj">
                        DVS编号
                    </td>
                    <td colspan="3">
                        <asp:TextBox ID="txtDvsNo" runat="server" class="con_middle"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="con_new_table_obj">
            ...
            <h3>
                查询结果</h3>
            <asp:GridView runat="server" ID="gvwCamera" AllowPaging="True" AllowSorting="True"
                AutoGenerateColumns="False" EmptyDataText="没有记录" RowHeaderColumn="ID" Width="90%" OnRowDeleting="gvwCamera_RowDeleting" OnPageIndexChanging="gvwCamera_PageIndexChanging">
                <PagerSettings FirstPageText="首页" LastPageText="末页" NextPageText="下一页" PageButtonCount="10"
                            ...
                            <PagerStyle Font-Underline="true" Font-Size="X-Large" BackColor="Coral" Width="400px" Font-Bold="false" />
                <Columns>
                    ...
                    <asp:HyperLinkField DataNavigateUrlFields="id" DataNavigateUrlFormatString="ResCamera.aspx?id={0}"
                        DataTextField="CAREMANO" DataTextFormatString="{0}" HeaderText="摄像头编码">
                        <ItemStyle Width="150px" />
                    </asp:HyperLinkField>
                    <asp:BoundField DataField="CAREMAKIND" HeaderText="摄像头型号">
                    ...
                    <asp:BoundField DataField="dvsid" HeaderText="DVS编号">
                        <ItemStyle Width="150px" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Dvsport" HeaderText="管道ID">
                        <ItemStyle Width="50px" />
                    </asp:BoundField>
