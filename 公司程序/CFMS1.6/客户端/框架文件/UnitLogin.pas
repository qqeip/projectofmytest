...
uses
  ...
  Dialogs, StdCtrls, Buttons,ExtCtrls,inifiles, WinSkinData, jpeg;
...
type
  TFormLogin = class(TForm)
    ...
    procedure EditUserNoKeyDown(Sender: TObject; var Key: Word;
      Shift: TShiftState);
...
begin
  ...
  try
    ...
    for i:=0 to lStringList.Count-1 do
      EditUserNo.Items.Add( lStringList.Values['User'+IntToStr(i+1)]);
   //
    EditUserNo.Text:= linifile.ReadString('LastLogin','UserNo','')
  finally
    linifile.Free;
    lStringList.Free;
  end;
...
procedure TFormLogin.EditUserNoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
