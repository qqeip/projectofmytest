...
// $Rev: 8291 $
// File generated on 2010-2-24 9:41:08 from Type Library described below.

// ************************************************************************  //
// Type Lib: D:\POP\MTS\03_±àÂë\MTS2.5\MTS·þÎñ¶Ë\MTS_Server.tlb (1)
...
// *********************************************************************//
  IRDM_MTS = interface(IAppServer)
    ...
    function ChangePassword(const OldPassword: WideString; const NewPassword: WideString; 
                            const UserNo: WideString): Smallint; safecall;
...
// *********************************************************************//
  IRDM_MTSDisp = dispinterface
    ...
    function ChangePassword(const OldPassword: WideString; const NewPassword: WideString; 
                            const UserNo: WideString): Smallint; dispid 308;
    function GetTheSequenceId(const Seqname: WideString): Integer; dispid 309;
    function GetRingRemind(aCityid: Integer; aUserid: Integer; aRemindType: Integer; 
                           out vIsRing: Integer; out vWavName: WideString): Integer; dispid 310;
