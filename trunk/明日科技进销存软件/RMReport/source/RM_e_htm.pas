...
var
  ...
  function _ExportPicture(aDataRec: TRMEFDataRec): string; // 导出图片
  var
    lImageIndex: Integer;
  begin
    Result := '';
    if (not ExportImages) or (aDataRec.Bitmap = nil) then Exit;
    ...
    begin
      ...
      lFileName := SaveBitmapAs(aDataRec.Bitmap,
    ...
    aDataRec.Bitmap.Free; aDataRec.Bitmap := nil;
  ...
  procedure _ExportText(aDataRec: TRMEFDataRec);
  var
    i, lCount: Integer;
    t: TRMCustomMemoView;
    lOutputStr: string;
  ...
  begin
    ...
    begin
      ...
      WriteToStream(Stream, lOutputStr);
    end;
  end;
  ...
  begin
    ...
    begin
      ...
      lBorderInfo := '';
      lBackGroundInfo := '';
      if lDataRec.ObjType = rmotPicture then
  ...
  begin
    ...
    begin
      Application.ProcessMessages;
      lDataRec := FDataList[I];
      if lDataRec.ObjType = rmotMemo then
