...
uses
  ...
  SConnect, RM_Class, RM_Dataset, RMD_DBWrap, RM_Parser, JvInterpreter
...
procedure TRMDDCOMConnection.Loaded;
begin
  try
...
procedure TRMDSocketConnection.Loaded;
begin
  try
    ObjectBroker := FFixupList['ObjectBroker'];
  except;
